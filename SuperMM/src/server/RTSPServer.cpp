...
//            res.append("\r\n");
        ...
        case REQUEST_SETUP:
        {
            ...
            info = mRTPSender->addSenderInfo(trackID, rtpport);
...
//            res.append("\r\n");
            ...
            sprintf(buff, "Transport: %s;source=192.168.1.100;server_port=%d-%d;ssrc=0B0533AE", 
                    transport.c_str(), info.RTPPort, info.RTPPort + 1);
            res.append(buff);
        ...
        case REQUEST_PLAY:
        {
            ...
            res.append("RTP-Info: ");
            res.append("url=rtsp://192.168.1.100:3333/512*298.flv/trackID=1;seq=0;rtptime=0,");
            res.append("url=rtsp://192.168.1.100:3333/512*298.flv/trackID=0;seq=0;rtptime=0");
            res.append("\r\n");
            res.append("\r\n");
        ...
        case REQUEST_OPTIONS:
        {
            ...
            res.append(cseq);
            res.append("\r\n");
            res.append("Public: DESCRIBE, SETUP, TEARDOWN, PLAY");
            res.append("\r\n");
            res.append("\r\n");
            break;
        }
